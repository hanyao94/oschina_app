...
import 'package:oschina_app/widgets/SlideView.dart';
...
class NewsListPage extends StatelessWidget {
  ...
  Widget renderRow(i) {
    ...
    var row = new Row(
      children: <Widget>[
        // 左边是标题，时间，评论数等信息
        new Expanded(flex: 1, child: new Padding(
